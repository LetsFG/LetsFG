      ...
      <div className="rf-card-shell">
        ...
        <div className="rf-list">
          {visibleOffers.map((offer, index) => {
            ...
            const perTravelerDisplayPrice = travelerCount > 1
              ? Math.round((sortDisplayPrice / travelerCount) * 100) / 100
              : sortDisplayPrice
              ...
              <div className={`rf-card${isHero ? ' rf-card--hero' : ''}${isRunnerUp ? ' rf-card--runner' : ''}${!isHero && !isRunnerUp ? ' rf-card--list' : ''}${isExpanded ? ' rf-card--expanded' : ''}${newOfferIds?.has(offerKey) ? ' rf-card--new' : ''}`}>
                ...
                <div className={`rf-card-row${!isUnlocked ? ' rf-card-row--locked' : ''}`}>
                  ...
                  <div className="rf-price-wrap">
                    ...
                    <span className="rf-price-sub">{travelerCount > 1 ? `${fmt(perTravelerDisplayPrice)} ${t('perPerson')}` : t('priceTotal')}</span>
