...
_TEMPORARILY_DISABLED: set[str] = {
    ...
    # delta_direct, indigo_direct, pegasus_direct — re-enabled 2026-04-18 (comprehensive Chrome flags + Akamai warm-up + residential proxy)
...
_DIRECT_AIRLINE_connectorS: list[tuple[str, type, float]] = [
    ...
    ("citilink_direct", CitilinkConnectorClient, 75.0),  # Indonesia WAF very slow, ~107s observed
